...
/**
 * FallingPattern — animation d'arrière-plan à points qui tombent (effet pluie/étoiles).
 * Props :
 *  - color: couleur des points (défaut: doré LocaMaison)
 *  - backgroundColor: couleur des "trous" du masque flouté (défaut: transparent pour laisser voir le calque derrière)
 *  - duration: durée d'un cycle complet en secondes
 *  - blurIntensity: intensité du flou du masque
 *  - density: densité du motif de trous
 */
